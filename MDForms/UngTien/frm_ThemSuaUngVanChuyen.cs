...
namespace MDSolution.MDForms.UngTien
{
    public partial class frm_ThemSuaUngVanChuyen : Form
    {
        ...
        public frm_ThemSuaUngVanChuyen(long UVT_ID, string SoXe)
        {
            ...
            clsKeHoachUngVanChuyen oUVTSua = new clsKeHoachUngVanChuyen(UVT_ID);
            oUVTSua.Load(UVT_ID,null, null);
            HopDongVanChuyenID = oUVTSua.HopDongID;
            cboLoaiVT.SelectedValue = oUVTSua.LoaiVatTuID;
        ...
        { 
        bool check=false;
        string sql = "Select ID from tbl_KeHoachUngVanChuyen where VuTrongID=" + MDSolutionApp.VuTrongID.ToString() + " AND SoChungTu="+ SoChungTu;
        try
        {
        ...
        private void cmdOK_Click(object sender, EventArgs e)
        {
            if (Valid_Form())
            {
                try
                {
                    ...
                    {
                        clsKeHoachUngVanChuyen oUVT = new clsKeHoachUngVanChuyen();
                        oUVT.HopDongID = HopDongVanChuyenID;
                        
                        oUVT.LoaiVatTuID = long.Parse(cboLoaiVT.SelectedValue.ToString());
                    ...
                    {
                        clsKeHoachUngVanChuyen oUVT = new clsKeHoachUngVanChuyen(UVTID);
                        oUVT.Load(UVTID,null, null);
                        oUVT.HopDongID = HopDongVanChuyenID;
                        ...
                        oUVT.Sotien = nSoTien.Value;
                        oUVT.BangChu = rtbBangChu.Text;
                        oUVT.DateModify = DateTime.Today;
                        oUVT.ModifyByUserID = MDSolutionApp.User.ID;
                        oUVT.Save(null, null);
