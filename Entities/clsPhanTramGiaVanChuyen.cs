...
{
    public class clsPhanTramGiaVanChuyen
    {
        public long ID = -1;
        ...
        public clsPhanTramGiaVanChuyen()
        {
            //
            // TODO: Add constructor logic here
            //
        }
        public clsPhanTramGiaVanChuyen(long lID)
        {
            ID = lID;
        }
        ...
        public void Save(OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            if (ID <= 0) // new object, we insert new record to database
            {
                ...
                strSQL = "Insert into tbl_PhanTramGiaVanChuyen" +
                "(VatTuID,DonGia,NgayApDung,IsActive,VuTrongID, CreateBy, ModifyBy, DateModify,GhiChu) Values(" +
            ...
            else // edit object, we update old record in database
            {
                ...
                strSQL = "Update tbl_PhanTramGiaVanChuyen set " +
            ...
            /*
            if( ID <= 0 )
                ID = long.Parse(DBModule.ExecuteQueryGetOneResult("SELECT Max(ID) FROM tbl_PhanTramGiaVanChuyen", cn, trans));
                */
        }
        public void Delete(OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            strSQL = "Delete from tbl_PhanTramGiaVanChuyen where ID=" + ID.ToString();
            // run SQL statement
            DBModule.ExecuteNonQuery(strSQL, cn, trans);
        ...
        public static void Delete(long iID, OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            strSQL = "Delete from tbl_PhanTramGiaVanChuyen where ID=" + iID.ToString();
            // run SQL statement
            DBModule.ExecuteNonQuery(strSQL, cn, trans);
        }
        public static void DeleteQLKH(long iID, OleDbConnection cn, OleDbTransaction trans)
        {
            string strSQL = "";
            // build SQL statement
            strSQL = "Delete from tbl_PhanTramGiaVanChuyen where QuanLyVaKhauHaoID=" + iID.ToString();
            // run SQL statement
            DBModule.ExecuteNonQuery(strSQL, cn, trans);
        }
        ...
        public void Load(OleDbConnection cn, OleDbTransaction trans)
        {
            // build SQL statement
            string strSQL = "";
            strSQL = "Select * from tbl_PhanTramGiaVanChuyen where ID=" + ID.ToString();
            // run SQL statement
        ...
        public static void GetList(string OrderBy, out DataSet ds, OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            ds = null;
            // build SQL statement
            strSQL = "Select * from tbl_PhanTramGiaVanChuyen ";
        ...
        public static DataSet GetListbyWhere(string strFields, string strWhere, string strOrderBy, OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            string strSQL = "SELECT " + strFields + " FROM tbl_PhanTramGiaVanChuyen WHERE 1=1";
        ...
        public static void GetListDot(string OrderBy, out DataSet ds, OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            ds = null;
            // build SQL statement
            strSQL = "Select Distinct DotDauTu from tbl_PhanTramGiaVanChuyen ORDER BY DotDauTu ASC";
            if ((OrderBy != null) && (OrderBy != ""))
                strSQL = strSQL + " Order By " + DBModule.RefineString(OrderBy);
            ds = DBModule.ExecuteQuery(strSQL, cn, trans);
