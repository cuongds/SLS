...
{
    public class clsHoTroVanChuyen
    {
        public long ID = -1;
        ...
        public clsHoTroVanChuyen()
        {
            //
            // TODO: Add constructor logic here
            //
        }
        public clsHoTroVanChuyen(long lID)
        {
            ID = lID;
        }
        ...
        public void Save(OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            {
                //id = lddata.DBModule.GetNewID(typeof(HoTro), "tbl_HoTroVanChuyen", cn, trans);
                ID = DBModule.GetNewID(typeof(clsHoTroVanChuyen), "tbl_HoTroVanChuyen", cn, trans);
                //NgayTao = DateTime.Now;        
                //NgaySua = DateTime.Now;        
                // build SQL statement
                strSQL = "Insert into tbl_HoTroVanChuyen" +
            ...
            else // edit object, we update old record in database
            {
                // build SQL statement				    
                //NgaySua = DateTime.Now;        
                strSQL = "Update tbl_HoTroVanChuyen set " +
            ...
            /*
            if( ID <= 0 )
                ID = long.Parse(DBModule.ExecuteQueryGetOneResult("SELECT Max(ID) FROM tbl_HoTroVanChuyen", cn, trans));
                */
        }
        public void Delete(OleDbConnection cn, OleDbTransaction trans)
        {
            string strSQL = "";
            // build SQL statement
            strSQL = "Delete from tbl_HoTroVanChuyen where ID=" + ID.ToString();
            // run SQL statement
            DBModule.ExecuteNonQuery(strSQL, cn, trans);
        }
        public static void Delete(long iID, OleDbConnection cn, OleDbTransaction trans)
        {
            string strSQL = "";
            // build SQL statement
            strSQL = "Delete from tbl_HoTroVanChuyen where ID=" + iID.ToString();
            // run SQL statement
            DBModule.ExecuteNonQuery(strSQL, cn, trans);
        }
        public static void DeleteLoaiHinh(long iID, OleDbConnection cn, OleDbTransaction trans)
        {
            string strSQL = "";
            // build SQL statement
            strSQL = "Delete from tbl_HoTroVanChuyen where HoTroTheoLoaiHinhID=" + iID.ToString();
            // run SQL statement
            DBModule.ExecuteNonQuery(strSQL, cn, trans);
        }
        public void Load(OleDbConnection cn, OleDbTransaction trans)
        {
            // build SQL statement
            string strSQL = "";
            strSQL = "Select * from tbl_HoTroVanChuyen where ID=" + ID.ToString();            
        ...
        public static void GetList(string OrderBy, out DataSet ds, OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            ds = null;
            // build SQL statement
            strSQL = "Select * from tbl_HoTroVanChuyen ";
        ...
        public static DataSet GetListbyWhere(string strFields, string strWhere, string strOrderBy, OleDbConnection cn, OleDbTransaction trans)
        {
            ...
            string strSQL = "SELECT " + strFields + " FROM tbl_HoTroVanChuyen WHERE 1=1";
