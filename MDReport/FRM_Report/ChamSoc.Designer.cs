namespace MDSolution.MDReport.FRM_Report
{
    partial class ChamSoc
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lbTitle.Text = "Tổng hợp chăm sóc";
            ...
            uiComboBoxItem1.Text = "Biểu cơ cấu giống";
            uiComboBoxItem1.Value = "ChamSoc\\\\BieuTongHopCoCauGiongNguyenLieu.rpt";
            uiComboBoxItem2.FormatStyle.Alpha = 0;
            uiComboBoxItem2.IsSeparator = false;
            uiComboBoxItem2.Text = "Biểu tổng cơ cấu giống";
            uiComboBoxItem2.Value = "ChamSoc\\\\BieuTongHopCoCauGiongNguyenLieuTong.rpt";
            uiComboBoxItem3.FormatStyle.Alpha = 0;
            uiComboBoxItem3.IsSeparator = false;
            uiComboBoxItem3.Text = "Sản lượng theo bãi bốc xếp";
            uiComboBoxItem3.Value = "ChamSoc\\\\SanLuongLanHaiTheoBaiBocXep.rpt";
            uiComboBoxItem4.FormatStyle.Alpha = 0;
            uiComboBoxItem4.IsSeparator = false;
            uiComboBoxItem4.Text = "Sản lượng theo bãi bốc xếp tổng";
            uiComboBoxItem4.Value = "ChamSoc\\\\SanLuongLanHaiTheoBaiBocXepTongXa.rpt";
