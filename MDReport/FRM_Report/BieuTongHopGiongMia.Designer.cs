namespace MDSolution.MDReport.FRM_Report
{
    partial class BieuTongHopGiongMia
    {
        ...
        private void InitializeComponent()
        {
            ...
            uiComboBoxItem1.Text = "Biểu tổng hợp giống theo trạm";
            uiComboBoxItem1.Value = "TongHopTheGiongMia\\\\TongHop.rpt";
            uiComboBoxItem2.FormatStyle.Alpha = 0;
            uiComboBoxItem2.IsSeparator = false;
            uiComboBoxItem2.Text = "Biểu tổng hợp giống theo huyện";
            uiComboBoxItem2.Value = "TongHopTheGiongMia\\\\GiongTram.rpt";
            uiComboBoxItem3.FormatStyle.Alpha = 0;
            uiComboBoxItem3.IsSeparator = false;
            uiComboBoxItem3.Text = "Tổng hợp theo kiểu trồng";
            uiComboBoxItem3.Value = "TongHopTheGiongMia\\\\TongHopTheoKieuTrong.rpt";
            uiComboBoxItem4.FormatStyle.Alpha = 0;
            uiComboBoxItem4.IsSeparator = false;
            uiComboBoxItem4.Text = "Tổng hợp theo loại đất";
            uiComboBoxItem4.Value = "TongHopTheGiongMia\\\\TongHopTheoLoaiDat.rpt";
            uiComboBoxItem5.FormatStyle.Alpha = 0;
            uiComboBoxItem5.IsSeparator = false;
            uiComboBoxItem5.Text = "Tổng hợp theo kiểu trồng tổng";
            uiComboBoxItem5.Value = "TongHopTheGiongMia\\\\TongHopTheoKieuTrongTong.rpt";
            uiComboBoxItem6.FormatStyle.Alpha = 0;
            uiComboBoxItem6.IsSeparator = false;
            uiComboBoxItem6.Text = "Tổng hợp theo loại đất xã";
            uiComboBoxItem6.Value = "TongHopTheGiongMia\\\\TongHopTheoLoaiDatTong.rpt";
            uiComboBoxItem7.FormatStyle.Alpha = 0;
            uiComboBoxItem7.IsSeparator = false;
            uiComboBoxItem7.Text = "Sản lượng theo giống thực tế";
            uiComboBoxItem7.Value = "NguyenLieu\\\\SanLuongTheogiongThucTe.rpt";
