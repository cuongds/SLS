namespace MDSolution.MDReport.FRM_Report
{
    partial class TongHopDauTu
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lbTitle.Text = "Tổng hợp đầu tư";
            ...
            uiComboBoxItem1.Text = "Báo cáo tổng hợp đầu tư trực tiếp";
            uiComboBoxItem1.Value = "DauTu\\\\DauTuTrucTiepVuEp1.rpt";
            uiComboBoxItem2.FormatStyle.Alpha = 0;
            uiComboBoxItem2.IsSeparator = false;
            uiComboBoxItem2.Text = "Biểu tổng đầu tư theo cán bộ địa bàn";
            uiComboBoxItem2.Value = "DauTu\\\\DauTuTheoCanBoNongVu.rpt";
            uiComboBoxItem3.FormatStyle.Alpha = 0;
            uiComboBoxItem3.IsSeparator = false;
            uiComboBoxItem3.Text = "Đầu tư Trực tiếp in A4";
            uiComboBoxItem3.Value = "DauTu\\\\DauTuTrucTiepInChuan.rpt";
            uiComboBoxItem4.FormatStyle.Alpha = 0;
            uiComboBoxItem4.IsSeparator = false;
            uiComboBoxItem4.Text = "Biểu tổng hợp đầu tư chưa trả nợ";
            uiComboBoxItem4.Value = "DauTu\\\\DauTrucTiepChuaTraNo.rpt";
